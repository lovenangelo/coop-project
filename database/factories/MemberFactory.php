...
class MemberFactory extends Factory
{
  ...
  public function definition(): array
  {
    return [
      ...
      'dob' => $this->faker->dateTimeBetween('-5 year', 'now'),
      'occupation' => $this->faker->jobTitle,
      'age' => $this->faker->numberBetween(20, 60),
      'gender' => $this->faker->randomElement(['Male', 'Female']),
      'civil_status' => $this->faker->randomElement(['Married', 'Single']),
      'address' => $this->faker->randomElement(["BINOGSACAN UPPER, GUINOBATAN, ALBAY", "CABUGAN, BURUANGA, AKLAN", "BANGCUD, CITY OF MALAYBALAY, BUKIDNON"]),
